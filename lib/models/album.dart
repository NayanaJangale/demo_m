...
class Album {
  ...
  Album.fromJson(Map<String, dynamic> map) {
    ...
    album_desc = map[AlbumFieldNames.album_desc] ?? StringHandlers.NotAvailable;
  }
...
class AlbumUrls {
  static const String GET_TEACHER_ALBUMS = 'Gallery/GetAllAlbums';
  static const String GET_ALBUM_PHOTO = 'Gallery/GetAlbumPhoto';
  static const String ADD_NEW_ALBUM = 'Gallery/AddNewAlbum';
}
