...
class Period {
  ...
  Period.fromMap(Map<String, dynamic> map) {
    ...
    class_name =
        map[PeriodFieldNames.class_name] ?? StringHandlers.NotAvailable;
    division_name =
        map[PeriodFieldNames.division_name] ?? StringHandlers.NotAvailable;
    subject_name =
        map[PeriodFieldNames.subject_name] ?? StringHandlers.NotAvailable;
  }
