...
import 'package:teachers/components/bottom_curved_Painter.dart';
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: isEnable ?Theme.of(context).primaryColor: Colors.white,
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                      color: isEnable ? Theme.of(context).primaryColorLight : Colors.white,
                      blurRadius: 10,
                      spreadRadius: 5,
                      offset: Offset(5, 5),
                    ),
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                _icon(Icons.menu, _selectedIndex == 1, 1),
